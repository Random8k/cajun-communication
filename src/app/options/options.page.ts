...
export class OptionsPage implements OnInit {
  ...
  saveToString(toSave){
    toSave = this.sourceList.toString();
    this.sourceListAsArray = toSave;
  ...
  sites = [
    ...
    },
    {
      ...
      description:
        "The AP delivers indepth coverage on the international, politics, lifestyle, business, and entertainment news.",
    ...
    },
    {
      ...
      description:
        "Business Insider is a fastgrowing business site with deep financial, media, tech, and other industry verticals. Launched in 2007, the site is now the largest business news site on the web.",
    ...
    },
    {
      ...
      name: "Buzzfeed",
      description:
        "BuzzFeed is a crossplatform, global network for news and entertainment that generates seven billion views each month.",
    ...
    },
    {
      ...
      name: "ESPN",
      description:
        "ESPN has uptotheminute sports news coverage, scores, highlights and commentary for NFL, MLB, NBA, College Football, NCAA Basketball and more.",
    ...
    },
    {
      ...
      name: "ESPN Cric Info",
      description:
        "ESPN Cricinfo provides the most comprehensive cricket coverage available including live ballbyball commentary, news, unparalleled statistics, quality editorial comment and analysis.",
    ...
    },
    {
      ...
      name: "IGN",
      description:
        "IGN is your site for Xbox One, PS4, PC, WiiU, Xbox 360, PS3, Wii, 3DS, PS Vita and iPhone games with expert reviews, news, previews, trailers, cheat codes, wiki guides and walkthroughs.",
    ...
    },
    {
      ...
      name: "Mashable",
      description:
        "Mashable is a global, multiplatform media and entertainment company.",
    ...
    },
    {
      ...
      name: "MSNBC",
      description:
        "Breaking news and indepth analysis of the headlines, as well as commentary and informed perspectives from The Rachel Maddow Show, Morning Joe & more.",
    ...
    },
    {
      ...
      name: "Newsweek",
      description:
        "Newsweek provides indepth analysis, news and opinion about international issues, technology, business, culture and politics.",
    ...
    },
    {
      ...
      name: "NHL News",
      description:
        "The most uptodate breaking hockey news from the official source including interviews, rumors, statistics and schedules.",
